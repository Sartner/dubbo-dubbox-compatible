...
public class DubboCodec extends ExchangeCodec {
    ...
    protected void encodeRequestData(Channel channel, ObjectOutput out, Object data, String version) throws IOException {
        ...
        String targetVersion = inv.getInvoker().getUrl().getParameter("dubbo");
        if(StringUtils.isNotEmpty(targetVersion) && targetVersion.startsWith("2.8.4")){
            encodeDubboxRequestData(channel, out, inv, version);
            return;
        }
    ...
    protected void encodeDubboxRequestData(Channel channel, ObjectOutput out, RpcInvocation inv, String version) throws IOException {
