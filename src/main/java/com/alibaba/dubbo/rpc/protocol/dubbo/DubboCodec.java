...
public class DubboCodec extends ExchangeCodec implements Codec2 {
    ...
    protected void encodeApacheDubboRequestData(Channel channel, ObjectOutput out, RpcInvocation inv, String version) throws IOException {
    ...
    protected void encodeRequestData(Channel channel, ObjectOutput out, Object data) throws IOException {
        ...
        if(Version.isSupportResponseAttachment(inv.getInvoker().getUrl().getParameter("dubbo"))){
            encodeApacheDubboRequestData(channel, out, inv, "2.0.2");
            return;
        }
